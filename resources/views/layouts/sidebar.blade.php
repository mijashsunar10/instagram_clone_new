    ...
    <ul class="space-y-4 mt-2">
        ...
        <li><a wire:navigate href="/" class="flex items-center gap-5 ">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" text-lg font-extrabold">Home</h4>
            </a></li>
        ...
        <li><a  class="flex items-center gap-5">
                ...
                <span>
                    ...
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
                        <path fill-rule="evenodd" clip-rule="evenodd" d="M12 2.25C6.615 2.25 2.25 6.615 2.25 12C2.25 17.385 6.615 21.75 12 21.75C17.385 21.75 21.75 17.385 21.75 12C21.75 6.615 17.385 2.25 12 2.25ZM3.75 12C3.75 7.727 7.727 3.75 12 3.75C16.273 3.75 20.25 7.727 20.25 12C20.25 16.273 16.273 20.25 12 20.25C7.727 20.25 3.75 16.273 3.75 12ZM16.5 7.5L13.317 13.317L7.5 16.5L10.683 10.683L16.5 7.5ZM12.75 11.25L13.317 10.683L10.683 13.317L11.25 12.75L12 12L12.75 11.25Z" />
                      </svg>
        ...
        <li>
            <a class="flex items-center gap-5">
                ...
                <h4 x-cloak x-show="!(shrink||drawer)"
                    class=" text-lg font-medium ">Profile</h4>
            </a>
        </li>
